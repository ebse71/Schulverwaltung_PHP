...
if (!checkToken()) {
    // Eğer token geçersizse, sadece bir uyarı mesajı gösteriyoruz
...
// Kullanıcı sayfayı kullanıyorsa son etkinlik zamanını güncelle
        ...
        function loadSubMenu(contentId) {
            ...
            switch (contentId) {
                ...
                case 'veli-islemleri':
                    subMenuHtml = `
                        <div class="button-grid">
                            <a href="#" data-action="veli-ekle"><i class="fas fa-user-friends"></i>Veli Ekle</a>
                            <a href="#" data-action="veli-guncelle"><i class="fas fa-user-friends"></i>Veli Güncelle</a>
                            <a href="#" data-action="veli-sil"><i class="fas fa-user-friends"></i>Veli Sil</a>
                        </div>
                    `;
                    break;
                case 'duyurular':
